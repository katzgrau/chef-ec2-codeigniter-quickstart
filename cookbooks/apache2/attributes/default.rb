...
when "redhat","centos","scientific","fedora","suse"
  ...
  set[:apache][:log_dir] = "/home/webapp/logs/apache"
  set[:apache][:error_log] = "error.log"
  set[:apache][:user]    = "webapp"
  set[:apache][:group]   = "admin"
...
when "freebsd"
  ...
  set[:apache][:dir]     = "/etc/apache2"
  set[:apache][:log_dir] = "/home/webapp/logs/apache2"
  set[:apache][:error_log] = "error.log"
  set[:apache][:user]    = "webapp"
  set[:apache][:group]   = "admin"
  set[:apache][:binary]  = "/usr/sbin/apache2"
...
default[:apache][:contact] = "info@example.com"
